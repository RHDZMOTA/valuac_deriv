...
@
A continuación se muestra una tabla comparativa de las distintas primas ya descritas anteriormente exceptuando la de las simulaciones pues se calculará en párrafos posteriores.
...
concepto <- c('Prob. Ganar')
derivados <- c('Opción Call', 'Forward', "Neto de la opción call")
@
...
\begin{table}[h!]
  ...
  \begin{tabular}{|l|l|l|}\hline
    ...
    \textbf{Concepto}  & \textbf{\Sexpr{derivados[1]}  \\ \hline
    
    \Sexpr{concepto[1]} & \Sexpr{prob_ganarf}            \\ \hline
    \Sexpr{concepto[2]} & \Sexpr{prob_ejerce}            \\ \hline
    \Sexpr{concepto[3]} & \Sexpr{prob_ganarn}            \\ \hline
