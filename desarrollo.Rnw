...
\section{Obtención de datos y neutralización al riesgo}
...
\section{Generación de aleatorios igualmente distribuidos}
...
\section{Creación de simulaciones para el tipo de cambio}
...
\section{Resultados gráficos de trayectoras simuladas}
...
\begin{figure}[H] \centering
\subfloat[$\text{Trayectorias simuladas}$]{\includegraphics[width = 6cm]{figure/graficas-1.pdf}}
\subfloat[$\text{Trayectorias simuladas junto con la trayectoria del tipo de cambio original}$]{\includegraphics[width = 6cm]{figure/graficas-2.pdf}}
\caption{Generalidades de las trayectorias}
\end{figure}


\section{Determinación de función de ganancias}
...
\subsection{Opción tipo \emph{call}}
...
\subsection{Contrato tipo forward}
...
\begin{figure}[H] \centering
\includegraphics[width = 6cm]{figure/funcion_ganancias-1.pdf}
\caption{Trayectorias con precio strike}
\end{figure}

\subsection{Probabilidades de obtener ganancias y ganancia esperada}
