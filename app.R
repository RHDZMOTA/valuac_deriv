...
ui <- fluidPage(
  fluidRow(
    column(12,
           ...
           mainPanel(
             p("AplicaciÛn diseÒada para analizar distintas estrategias financieras para cobertura 
             ...
             h3("DescripciÛn general"),
             p("A continuaciÛn se presenta la serie de tiempo diaria de la paridad de la moneda mexicana y el
               dÛlar estadunidense con 365 datos histÛricos. La metodologÌa empleada se basa en calcular 
               trayectorias mediante la determinaciÛn de la distribuciÛn real del rendimiento logarÌtmico  
               de los datos para asÌ obtener una buena estimaciÛn del tipo de cambio a 90 dÌas. Con esta 
               informaciÛn se eval˙a el rendimiento de estrategias propuestas con opciones tipo call y 
               futuros/forward."),
             ...
             column(6,
                    ...
                    fluidRow(
                      column(6, 
                             ...
                             contrato de opciÛn tipo call en el cual el usuario fija un precio 
                             de ejercicio (strike)."
                             ),
                      column(6,
                             "Gr·fico"),
